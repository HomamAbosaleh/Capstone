...
from sensor_msgs.msg import Imu, Image as ROSImage
...
class RobotController:
    ...
    def object_detection_service(self, pil_image):
        try:
            # From pil image to ros image
            ros_image = ROSImage()
            ...
            response = object_detection_service(ros_image).object
    ...
    def run(self):
        ...
        while not rospy.is_shutdown():
            ...
            pil_image = PILImage.fromarray(cv2.cvtColor(org_frame, cv2.COLOR_BGR2RGB))
            ...
            x1, x2, y1, y2, class_name = self.object_detection_service(pil_image)
